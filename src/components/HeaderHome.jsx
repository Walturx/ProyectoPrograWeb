...
function HeaderHome() {
  ...
  return (
    <header className="flex items-center justify-between bg-white-500 px-8 py-4 shadow-md h-30">
      ...
      <button className="bg-green-500 w-32 h-15 rounded-md flex flex-col justify-between items-start p-2 text-white hover:bg-blue-100 transition">
      ...
      .75.75 0 0 1 1.5 0Z" />
          ...
          <span className="text-sm font-medium">S/{price.toFixed(2)}</span>
        </div>
      </button>
